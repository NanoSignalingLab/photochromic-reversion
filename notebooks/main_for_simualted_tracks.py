...
if __name__ == '__main__':
    ...
    def wrapper_one_file(f1, f2, min_track_length, dt, plotting_flag): # works I guess
        ...
        tracks_input, deep_df1, traces, lys_x, lys_y = load_file(f1, min_track_length) # execute this function to load the files
        ...
        grouped_plot,lys_area2, lys_perimeter2, lys_hull2, lys_points_big2, deep_df_short, lys_points2=plotting_all_features_and_caculate_hull(deep_df6, plotting_flag)
        ...
        make_fingerprint_file(f2, train_result, deep_df_short2, dt) # run function to make excel with all parameters
    ...
    def read_in_values_and_execute(f1,min_track_length, dt, plotting_flag ):
        ...
        for index, row in df_values.iterrows():
            ...
            deep_df1, traces, lys_x, lys_y= make_deep_df(sim_tracks, min_track_length)
            train_result, states, lys_states = run_traces_wrapper(traces, dt)
            deep_df2=computing_distance_wrapper(deep_df1)
            deep_df3=calculate_angles_wrapper(deep_df2)
            deep_df4=calculate_KDE_wrapper(lys_x, lys_y, deep_df3)
            ...
            grouped_plot,lys_area2, lys_perimeter2, lys_hull2, lys_points_big2, deep_df_short, lys_points2=plotting_all_features_and_caculate_hull(deep_df6, plotting_flag)
            deep_df_short2=convex_hull_wrapper(grouped_plot,lys_area2, lys_perimeter2, lys_hull2, lys_points_big2, deep_df_short)
            list_accuracy=calculate_accuracy(sim_tracks, deep_df_short2)
    ...
    def load_file(path2, min_track_length):
        ...
        return df, deep_df, list_traces, lys_x, lys_y
    ...
    def plotting_all_features_and_caculate_hull(deep_df, plotting_flag): # add ture =1or false =0 for plotting yes or no
        ...
        if plotting_flag==1:
            plt.axis('equal') 
            plt.show()
        return grouped_plot,lys_area2, lys_perimeter2, lys_hull2, lys_points_big2, deep_df_short, lys_points2
    ...
    def make_fingerprint_file(f2, train_result, deep_df_short, dt): 
        lys_string=f2.split("\\")
    ...
    def calculate_accuracy(sim_tracks, finger_tracks):
        ...
        percent_correct=((both_confined+both_unconfined)/len(arry_sim))*100
    ...
    plotting_flag=1
    #wrapper_one_file(f1, f2, min_track_length, dt,plotting_flag ) 
    f1=r"C:\Users\miche\Desktop\simualted tracks\datasets_folder\test_values.csv"
    read_in_values_and_execute(f1,min_track_length, dt, plotting_flag )   